  ...
  return (
    <div className="max-w-2xl space-y-6 text-base text-washi-text">
      ...
      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第1条（適用）</h2>
        <p>本規約はユーザーと管理者間の本サービス利用に関する一切の関係に適用されます。管理者は個別規定を定めることがあり、矛盾が生じた場合は個別規定が優先されます。</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第2条（禁止事項）</h2>
        <p>ユーザーは以下の行為を行ってはなりません。</p>
        <ul className="list-disc list-inside space-y-1 text-washi-muted">
      ...
      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第3条（本サービスの提供の停止等）</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第4条（利用制限）</h2>
        <p>管理者は、ユーザーが本規約に違反した場合、またはその他管理者が不適当と判断した場合、予告なく当該ユーザーの利用を制限できます。これによりユーザーが被った損害について管理者は責任を負いません。</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第5条（保証の否認および免責事項）</h2>
      ...
      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第6条（サービス内容の変更等）</h2>
        <p>管理者は、ユーザーへの通知なく本サービスの内容を変更または中止できます。これによりユーザーが被った損害について管理者は責任を負いません。</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第7条（利用規約の変更）</h2>
        <p>管理者は、ユーザーへの通知なく本規約を変更できます。変更後に本サービスを利用したユーザーは、変更後の規約に同意したものとみなします。</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第8条（権利義務の譲渡の禁止）</h2>
        <p>ユーザーは、管理者の書面による事前承諾なく、本規約上の地位または権利義務を第三者に譲渡できません。</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-bold text-washi-text">第9条（準拠法・裁判管轄）</h2>
